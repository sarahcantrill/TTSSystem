document.addEventListener("DOMContentLoaded", () => {
    ...
    const categoryWords = {
        'starters': ['The', 'It', 'I', 'He', 'She', 'They', 'We', 'There', 'This', 'That', 'A', 'An', 'In', 'On', 'At', 'As', 'When', 'While', 'After', 'Before', 'Because', 'Although', 'Though', 'If', 'But', 'And', 'So', 'Since', 'Then', 'Now', 'However', 'Moreover', 'Furthermore', 'Therefore', 'Indeed', 'Also', 'Yet', 'Even', 'Some', 'Most', 'All', 'Each', 'One', 'Many', 'People', 'Time', 'Day', 'Could', 'Would', 'Please', 'I think','Let\'s', 'How about'],
        ...
        'common': ['and', 'or', 'but', 'because', 'with', 'without', 'to', 'from', 'in', 'on', 'at', 'by', 'for', 'too', 'just', 'very', 'not at all', 'match', 'similar'],
