document.addEventListener("DOMContentLoaded", () => {
    ...
    const categoryWords = {
        ...
        'responses': ['yes', 'no', 'maybe', 'sort of', 'I agree', 'I disagree', 'I understand', 'I dont understand', 'I need help', 'good idea', 'can you explain more', 'Ill let you know', 'Absolutely', "I'm not sure", "That's fine", 'Sounds Good', "I'm sorry", "It's OK"],
        ...
        'topics': ['idea', 'answer', 'question', 'presentation', 'topic', 'opinion', 'solution', 'point', 'example', 'group', 'project', 'task', 'sentence', 'word', 'slide', 'chart', 'diagram', 'problem', 'discussion'],
        'adjectives' : ['clear', 'confusing', 'interesting', 'boring', 'important', 'helpful', 'difficult', 'easy', 'hard', 'correct', 'wrong', 'new', 'old', 'next', 'previous', 'better', 'happy', 'sad', 'big', 'small', 'quickly', 'fast', 'slow', 'good', 'bad', 'warm', 'cold', 'bright', 'dark', 'loud', 'louder', 'quiet', 'quieter'],
