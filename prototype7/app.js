document.addEventListener("DOMContentLoaded", () => {
    ...
    const categoryWords = {
        'starters': ['Hi', 'Hello', 'The', 'It', 'I', 'He', 'She', 'They', 'We', 'There', 'This', 'That', 'A', 'An', 'In', 'On', 'At', 'As', 'When', 'While', 'After', 'Before', 'Because', 'Although', 'Though', 'If', 'But', 'And', 'So', 'Since', 'Then', 'Now', 'However', 'Moreover', 'Furthermore', 'Therefore', 'Indeed', 'Also', 'Yet', 'Even', 'Some', 'Most', 'All', 'Each', 'One', 'Many', 'People', 'Time', 'Day', 'Could', 'Would', 'Please', 'I think','Let\'s', 'How about'],
        ...
        'responses': ['yes', 'no', 'maybe', 'not really', 'sometimes', 'never', 'rarely', 'sort of', 'I agree', 'I disagree', 'I understand', 'I dont understand', 'I need help', 'good idea', 'can you explain more', 'Ill let you know', 'Absolutely', "I'm not sure", "That's fine", 'Sounds Good', "I'm sorry", "It's OK"],
        'subjects': ['I', 'I\'m', 'you', 'we', 'his', 'she', 'hers', 'they', 'them', 'their', 'it', 'the group', 'everyone', 'someone', 'people', 'we all', 'the team'],
        'verbs': ['am', 'is', 'are', 'was', 'were', 'have', 'need', 'want', 'like', 'think', 'know', 'understand', 'finished', 'read', 'write', 'say', 'show', 'explain', 'check', 'finish', 'start', 'can', 'should', 'must', 'help', 'ask', 'repeat', 'listen', 'answer', 'examine', 'speak', 'remember', 'try', 'work', 'believe'],
        'common': ['and', 'or', 'but', 'because', 'with', 'without', 'to', 'from', 'in', 'on', 'at', 'by', 'for', 'too', 'just', 'very', 'not at all', 'match', 'similar', 'yes', 'no'],
        'topics': ['idea', 'answer', 'question', 'presentation', 'topic', 'opinion', 'solution', 'point', 'example', 'group', 'project', 'task', 'sentence', 'word', 'slide', 'chart', 'diagram', 'problem', 'discussion', 'desktop', 'computer', 'laptop', 'phone', 'tablet', 'Ipad'],
